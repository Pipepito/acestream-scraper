...
Plans:
- [x] 05-01: Implement/verify multi-arch build pipeline and artifact publishing.
- [x] 05-02: Create architecture smoke-test checklist and validate runtime behavior.
