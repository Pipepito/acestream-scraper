...
Keep the root README focused on the project, features, and guide links. User setup,
configuration and contributor instructions live in `wiki/`; Docker Hub overview
text lives in `docs/dockerhub/`. PR change selection and lightweight validators
come from the trusted target ref. Missing baselines and unknown paths keep full
