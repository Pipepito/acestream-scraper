...
from app.schemas.tv_matching import TVMatchPreview, TVMatchApplyRequest, TVMatchApplyResponse
...
def preview_tv_matches(db: Session = Depends(get_db)) -> TVMatchPreview:
    try:
        return TVMatchingService(db).preview()
