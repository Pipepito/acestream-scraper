...
maintainer-provided installation. That installation was queried read-only; its
URLs, channel IDs and private coordinates are excluded from this report.
...
## Network limits during the investigation
...
server in a disposable test container did not restore fresh lookups. The precise
cause of that later lookup failure was not established.
